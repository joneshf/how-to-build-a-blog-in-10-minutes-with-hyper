...
var genericSemigroupField = function (dictSemigroup) {
...
var genericSemigroupRec = function (dictGenericSemigroup) {
    return new GenericSemigroup(function (v) {
        return function (v1) {
            return genericAppend$prime(dictGenericSemigroup)(v)(v1);
        };
...
module.exports = {
    ...
    genericSemigroupRec: genericSemigroupRec, 
    genericSemigroupField: genericSemigroupField
};
