...
var symlinkTypeToNode = function (ty) {
    ...
    throw new Error("Failed pattern match at Node.FS line 73, column 24 - line 78, column 1: " + [ ty.constructor.name ]);
};
var showSymlinkType = new Data_Show.Show(function (v) {
    ...
    throw new Error("Failed pattern match at Node.FS line 79, column 3 - line 80, column 3: " + [ v.constructor.name ]);
});
var showFileFlags = new Data_Show.Show(function (v) {
    ...
    throw new Error("Failed pattern match at Node.FS line 28, column 3 - line 29, column 3: " + [ v.constructor.name ]);
});
var fileFlagsToNode = function (ff) {
    ...
    throw new Error("Failed pattern match at Node.FS line 47, column 22 - line 61, column 1: " + [ ff.constructor.name ]);
};
